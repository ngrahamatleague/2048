...
public class Tile {
	...
	public void draw(Graphics g) {
		...
		case 64: 
			...
			g.drawString("64", col*100+40, row*100+40);
			break;
		case 128: g.setColor(Color.yellow);
		g.fillRect(col*100, row*100, 100, 100);

		g.setFont(font);
		g.setColor(Color.white);
		g.drawString("128", col*100+40, row*100+40);
		break;
		case 256: g.setColor(Color.yellow);
		g.fillRect(col*100, row*100, 100, 100);

		g.setFont(font);
		g.setColor(Color.white);
		g.drawString("256", col*100+40, row*100+40);
		break;
		case 512: g.setColor(Color.yellow);
		g.fillRect(col*100, row*100, 100, 100);

		g.setFont(font);
		g.setColor(Color.white);
		g.drawString("512", col*100+40, row*100+40);
		break;
		case 1024: g.setColor(Color.yellow);
		g.fillRect(col*100, row*100, 100, 100);

		g.setFont(font);
		g.setColor(Color.white);
		g.drawString("1024", col*100+40, row*100+40);
		break;
		case 2048: g.setColor(Color.yellow);
		g.fillRect(col*100, row*100, 100, 100);

		g.setFont(font);
		g.setColor(Color.white);
		g.drawString("2048", col*100+40, row*100+40);
		break;
